...
public class VisualizerOne : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach (var item in spectrumDataList)
        {
            ...
            cube1.transform.position = new Vector3(0, 0, -65);
            ...
            cube2.transform.position = new Vector3(0, 0, -65);
            ...
            cube3.transform.position = new Vector3(0, 0, -65);
            ...
            cube4.transform.position = new Vector3(0, 0, -65);
